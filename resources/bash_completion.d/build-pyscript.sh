...
__build_pyscript_bashcompletion()
{
	...
	local globalargs="--python --module-name --module --update --xml-description --skip-validation --no-validation --debug --help --ns-xml-path --ns-xml-path-relative -p -m -u -x -S -d"
