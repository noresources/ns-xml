...
__build_xulapp_bashcompletion()
{
	...
	local globalargs="--help --output --xml-description --shell --command --target-platform --target --update --skip-validation --no-validation --window-width --window-height --debug --init-script --resources --ns-xml-path --ns-xml-path-relative --ns-xml-add -h -o -x -t -u -S"
