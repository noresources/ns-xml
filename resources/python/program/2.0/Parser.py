...
class OptionNameBinding(object):
    name = ""
    info = None
    result = None
    parentResults = None
...
class ParserState(object):
    ...
    def initializeStateData(self, rootItemResult, option, groupIndex, resultTree=[]):
        ...
        for k, n in option.names:
            if rootItemResult == None:
                # print("init ", groupIndex, k)
                self.optionNameBindings[groupIndex][k] = OptionNameBinding(n, option, None)
            else:
                # print("set ", groupIndex, k, resultTree)
