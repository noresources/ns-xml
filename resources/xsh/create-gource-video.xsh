...
<xsh:program interpreterType="ksh" xmlns:prg="http://xsd.nore.fr/program" xmlns:xsh="http://xsd.nore.fr/xsh" xmlns:bash="http://xsd.nore.fr/bash" xmlns:xi="http://www.w3.org/2001/XInclude">
	<xsh:info>
