...
<xsh:program interpreterType="bash" xmlns:prg="http://xsd.nore.fr/program" xmlns:xsh="http://xsd.nore.fr/xsh" xmlns:xi="http://www.w3.org/2001/XInclude">
	<xsh:info>
		<xi:include href="update-php-parser.xml"/>
	</xsh:info>
	<xsh:functions>
		<xi:include href="../../ns/xsh/lib/base/base.xsh" xpointer="xmlns(xsh=http://xsd.nore.fr/xsh)xpointer(//xsh:function[@name = 'ns_print_error'])"/>
	...
	<xsh:code>
		...
		<xi:include href="update-php-parser.body.sh" parse="text"/>
	</xsh:code>
</xsh:program>
