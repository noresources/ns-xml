...
const CLASS_ID = Components.ID('93a6223d-e3a9-4ecb-8ed7-c6e501140f2b');
const CLASS_NAME = "Value AutoComplete";
const CONTRACT_ID = '@mozilla.org/autocomplete/search;1?name=ns-value-autocomplete';
...
ProviderAutoCompleteSearch.prototype = {
  ...
  startSearch: function(searchString, searchParam, previousResult, listener) {
	try
	{
		var results = JSON.parse(searchParam);
